...
namespace Client.Scenes.Views
{
    public sealed class InventoryDialog : DXWindow
    {
        ...
        {
            TitleLabel.Text = "背包";
            SetClientSize(new Size(640, 740));
            ...
            dxItemGrid1.GridSize = new Size(17, 17);
            ...
            dxItemGrid2.GridSize = new Size(17, 17);
            ...
            dxItemBaoshi3.GridSize = new Size(17, 17);
            ...
            dxItemBaoshi3.VisibleHeight = 17;
        ...
        {
            PatchGrid.GridSize = new Size(17, Math.Max(17, (int)Math.Ceiling((double)GameScene.Game.PatchGridSize / 17.0)));
        ...
        {
            BaoshiGrid.GridSize = new Size(17, Math.Max(17, (int)Math.Ceiling((double)GameScene.Game.BaoshiGridSize / 17.0)));
